...
git -c credential.https://github.com.helper= -c credential.https://github.com.helper=osxkeychain push -f https://github.com/TjmerMTA/pflegedienst-alno.git gh-pages
rm -rf .git
